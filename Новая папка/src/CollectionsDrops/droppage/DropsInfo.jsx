...
const DropsInfo = (props) => {
    ...
    useEffect(() => {
        GetLogo(id).then(data => {
            setInfo(data.collection.img)
            setTemplate(data.immutable_data.name)
        })
        ...
        <div className="drop_collection">
            ...
            <div className="buying_options">
                ...
                <div className="drop_buy_input">
                    <div>
                        <p className="quanity_div"><img style={{ 'width': 20, 'margin': '0px 10px'}} src={supplyimg}/> Quantity</p>
                        <p className="Available">Available: 5</p>
                    </div>
